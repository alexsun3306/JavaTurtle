...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, MouseWheelListener,KeyListener {
    ...
    public static Graphics2D getOffscreen() {
		return offscreen;
	}
    ...
    public class	EventOfMouse
    {
    	public	int	iEventType;
    	public	int	iButtonPressed;
    	public	double	dEventMouseX;
    	public	double	dEventMouseY;
    	public	EventOfMouse(int	iEventType,int	iButtonPressed,double	dEventMouseX,double	dEventMouseY)
    	{
    		this.iEventType = iEventType;
    		this.iButtonPressed = iButtonPressed;
    		this.dEventMouseX = dEventMouseX;
    		this.dEventMouseY = dEventMouseY;
    	}
    	
    	public	String	toString()
    	{
    		return	"event"+":("+iEventType+")"+":("+iButtonPressed+")"+":("+dEventMouseX+","+dEventMouseY+")";
    	}
    }
    // queue of typed key characters
    private static LinkedList<EventOfMouse> mouseEvents;
    ...
    private static void init() {
        ...
        mouseEvents  = new	LinkedList<EventOfMouse>();
...
*/
    ...
    ***************************************************************************/
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        mouseEvents.add(new EventOfMouse(0,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
    }
    ...
    public void mouseEntered(MouseEvent e) {
        // this body is intentionally left empty
        mouseEvents.add(new EventOfMouse(1,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
    }
    ...
    public void mouseExited(MouseEvent e) {
        // this body is intentionally left empty
        mouseEvents.add(new EventOfMouse(2,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
    }
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            ...
            isMousePressed = true;
            mouseEvents.add(new EventOfMouse(3,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
        }
    }
    ...
    public void mouseReleased(MouseEvent e) {
        synchronized (mouseLock) {
            ...
            mouseEvents.add(new EventOfMouse(4,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
        }
    }
    ...
    public void mouseDragged(MouseEvent e)  {
        synchronized (mouseLock) {
            mouseX = StdDraw.userX(e.getX());
            mouseY = StdDraw.userY(e.getY());
            mouseEvents.add(new EventOfMouse(5,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
        }
    }
    ...
    public void mouseMoved(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = StdDraw.userX(e.getX());
            mouseY = StdDraw.userY(e.getY());
            mouseEvents.add(new EventOfMouse(6,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
        }
    }
	...
	public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        mouseX = StdDraw.userX(e.getX());
        mouseY = StdDraw.userY(e.getY());
        int	iEvent = e.getWheelRotation()==1 ? 7:8;
        mouseEvents.add(new EventOfMouse(iEvent,e.getButton(),StdDraw.userX(e.getX()),StdDraw.userY(e.getY())));
    ...
    ***************************************************************************/
    ...
    public static boolean hasNextMouseEvent() {
        synchronized (mouseLock) {
            return !mouseEvents.isEmpty();
        }
    }
    
    public static EventOfMouse nextMouseEvent() {
        synchronized (mouseLock) {
            if (mouseEvents.isEmpty()) {
                throw new NoSuchElementException("your program has already processed all mouse events");
            }
            return mouseEvents.remove(mouseEvents.size() - 1);
            // return keysTyped.removeLast();
        }
    }
